...
func (r *DNSRule) SetOut(out string) {
	r.DefaultOptions.Server = out
}

func (r *DNSRule) SetList(name string, list []string) error {
	// switch name {
	// case "client", "Client":
	...
	// 	r.DefaultOptions.PortRange = Listable[string](list)
	// }
	// return nil
	switch name {
	case "client", "Client":
