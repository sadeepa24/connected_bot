...
func (o *OutboundTLSOptionsContainer) Changer(changer, value string) error {
	var err error
	if o.TLS == nil && (changer != "enabled")  {
		return errors.New("tls object not avbl")
	}
	switch changer {
	case "Enabled", "enabled":
		...
		if o.TLS.Enabled, err = strconv.ParseBool(value); err != nil {
			return err
		}
	case "ServerName",  "server_name":
		o.TLS.ServerName = value
	case "Insecure", "insecure":
		if o.TLS.Insecure, err = strconv.ParseBool(value); err != nil {
			return err
		}
	case "MinVersion", "min_version":
		o.TLS.MinVersion = value
	case "MaxVersion", "max_version":
		o.TLS.MaxVersion = value
	case "DisableSNI", "disable_sni":
		if o.TLS.DisableSNI, err = strconv.ParseBool(value); err != nil {
			return err
		}
	}
	return nil
