...
func (r *RuleSet) Change(changer, value string) error {
	...
	case C.RuleSetTypeLocal:
		switch changer {
		case "path":
			r.LocalOptions.Path = value
		default:
			return errors.New("field unsupported for rule set type " + r.Type)
		}
	case C.RuleSetTypeRemote:
		switch changer {
		case "url":
			r.RemoteOptions.URL = value
		case "download_detour":
			r.RemoteOptions.DownloadDetour = value
		default:
			return errors.New("field unsupported for rule set type " + r.Type)
		}
